...
\begin{document}
    ...
    The way I setup my scripts made it a simple configuration change to train a model for all stations and/or one model for all stations
    using any of the ML algorithms I investigated.\\

    I broke down the work for each of these two approaches into the following steps:
    ...
    The code for this coursework is available on my \href{https://github.com/isabelladegen/mlp-2021}{GitHub mlp-2021 repository} and
    all of the experiment runs are available on my \href{https://wandb.ai/idegen/mlp-2021}{Weights \& Biases - MLP 2021 workspace}.
    ...
    class from \nameref{phs:one} to keep track of which model to use for each station for creating the predictions.
    ...
    I calculated the MAE the same way as I've been doing in \nameref{phs:one} and the runs were logged to wandb as well.

    \subsection*{\nameref{phs:three}}
    \subsubsection*{\nameref{itm:phase3-step1}}
    In this step I combined the best model from \nameref{phs:one} with the best pretrained model created in \nameref{phs:two}
    ...
    and the Multilayer Perceptron Regressor for  each station (the best model from \nameref{phs:one}) and
