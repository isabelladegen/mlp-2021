...
\begin{document}
    ...
    \begin{description}
        ...
        \item [\namedlabel{itm:phase1-step4}{Step 4}] Do more feature investigation and engineering
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        3. Add weather data:
                - Percipitation cannot be added as it is 0.0 for all the provided data so nothing can be learned form it
                ...
                One model - Validation data: MAE 2.87527
