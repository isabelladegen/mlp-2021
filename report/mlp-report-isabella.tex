...
\begin{document}
    ...
    probably most easiest formualted as a regression problem. I want to not decide on the algorithm and instead try a few
    ...
    and do this testdriven. I from the beginning ensure that all parameters come from a configurations class \(no magic numbers and
    strings\), this also ensures that they automatically get logged in W&B with a run which helps to keep track of what I've run
